  ...
  const [storedBooks, setStoredBooks] = useState([
    {
      ...
      volumeInfo: {
        ...
        imageLinks: {
          smallThumbnail:
            "http://books.google.com/books/content?id=8DZ6uAEACAAJ&printsec=frontcover&img=1&zoom=5&source=gbs_api",
          thumbnail:
            "http://books.google.com/books/content?id=8DZ6uAEACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api",
        },
        language: "en",
        previewLink:
          "http://books.google.co.in/books?id=8DZ6uAEACAAJ&dq=naruto&hl=&cd=1&source=gbs_api",
        infoLink:
          "http://books.google.co.in/books?id=8DZ6uAEACAAJ&dq=naruto&hl=&source=gbs_api",
        canonicalVolumeLink:
          "https://books.google.com/books/about/Naruto_Box_Set_1.html?hl=&id=8DZ6uAEACAAJ",
      },
      saleInfo: {
        country: "IN",
      ...
      accessInfo: {
        ...
        webReaderLink:
          "http://play.google.com/books/reader?id=8DZ6uAEACAAJ&hl=&source=gbs_api",
        accessViewStatus: "NONE",
        quoteSharingAllowed: false,
      },
      searchInfo: {
        textSnippet:
          "Best selling VIZ series now in complete and fan-desirable sets! Save $ by buying the first complete story arc of Naruto! Special bonus premium items included in each like full color, two sided poster and mini-booklet.",
      },
    },
    {
      kind: "books#volume",
      ...
      volumeInfo: {
        ...
        imageLinks: {
          smallThumbnail:
            "http://books.google.com/books/content?id=Yr6GswEACAAJ&printsec=frontcover&img=1&zoom=5&source=gbs_api",
          thumbnail:
            "http://books.google.com/books/content?id=Yr6GswEACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api",
        },
        language: "de",
        previewLink:
          "http://books.google.co.in/books?id=Yr6GswEACAAJ&dq=naruto&hl=&cd=2&source=gbs_api",
        infoLink:
          "http://books.google.co.in/books?id=Yr6GswEACAAJ&dq=naruto&hl=&source=gbs_api",
        canonicalVolumeLink:
          "https://books.google.com/books/about/Naruto.html?hl=&id=Yr6GswEACAAJ",
      },
      saleInfo: {
        country: "IN",
        saleability: "NOT_FOR_SALE",
      ...
      accessInfo: {
        ...
        webReaderLink:
          "http://play.google.com/books/reader?id=Yr6GswEACAAJ&hl=&source=gbs_api",
        accessViewStatus: "NONE",
        quoteSharingAllowed: false,
      },
    },
    {
      ...
      volumeInfo: {
        ...
        imageLinks: {
          smallThumbnail:
            "http://books.google.com/books/content?id=Gzk5DwAAQBAJ&printsec=frontcover&img=1&zoom=5&source=gbs_api",
          thumbnail:
            "http://books.google.com/books/content?id=Gzk5DwAAQBAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api",
        },
        language: "de",
        previewLink:
          "http://books.google.co.in/books?id=Gzk5DwAAQBAJ&dq=naruto&hl=&cd=3&source=gbs_api",
        infoLink:
          "http://books.google.co.in/books?id=Gzk5DwAAQBAJ&dq=naruto&hl=&source=gbs_api",
        canonicalVolumeLink:
          "https://books.google.com/books/about/Naruto_1.html?hl=&id=Gzk5DwAAQBAJ",
      },
      saleInfo: {
        country: "IN",
        saleability: "NOT_FOR_SALE",
      ...
      accessInfo: {
        ...
        webReaderLink:
          "http://play.google.com/books/reader?id=Gzk5DwAAQBAJ&hl=&source=gbs_api",
        accessViewStatus: "NONE",
        quoteSharingAllowed: false,
      },
      searchInfo: {
        textSnippet:
          "Naruto ist ein berüchtigter Tunichtgut in seinem Dorf, das fast ausschließlich aus Ninja besteht.",
      },
    },
    {
      kind: "books#volume",
      ...
      volumeInfo: {
        ...
        description:
          "The third full-color art book from the hit series Naruto! Experience Masashi Kishimoto's artwork in all of its colorful glory in this collection of images from the conclusion of the best-selling Naruto manga! Naruto, Sasuke, Sakura, Kakashi and all your favorite characters appear in nearly a hundred pages of gorgeous full-color images. The book also features commentary from creator Masashi Kishimoto, a beautiful double-sided poster and a sticker sheet!",
        industryIdentifiers: [
          {
            type: "ISBN_10",
        ...
        imageLinks: {
          smallThumbnail:
            "http://books.google.com/books/content?id=TedvrgEACAAJ&printsec=frontcover&img=1&zoom=5&source=gbs_api",
          thumbnail:
            "http://books.google.com/books/content?id=TedvrgEACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api",
        },
        language: "en",
        previewLink:
          "http://books.google.co.in/books?id=TedvrgEACAAJ&dq=naruto&hl=&cd=4&source=gbs_api",
        infoLink:
          "http://books.google.co.in/books?id=TedvrgEACAAJ&dq=naruto&hl=&source=gbs_api",
        canonicalVolumeLink:
          "https://books.google.com/books/about/Uzumaki_Naruto_Illustrations.html?hl=&id=TedvrgEACAAJ",
      },
      saleInfo: {
        country: "IN",
        saleability: "NOT_FOR_SALE",
      ...
      accessInfo: {
        ...
        webReaderLink:
          "http://play.google.com/books/reader?id=TedvrgEACAAJ&hl=&source=gbs_api",
        accessViewStatus: "NONE",
        quoteSharingAllowed: false,
      },
      searchInfo: {
        textSnippet:
          "The third full-color art book from the hit series Naruto! Experience Masashi Kishimoto&#39;s artwork in all of its colorful glory in this collection of images from the conclusion of the best-selling Naruto manga!",
      },
    },
    {
      kind: "books#volume",
      ...
      volumeInfo: {
        ...
        imageLinks: {
          smallThumbnail:
            "http://books.google.com/books/content?id=rruOEAAAQBAJ&printsec=frontcover&img=1&zoom=5&source=gbs_api",
          thumbnail:
            "http://books.google.com/books/content?id=rruOEAAAQBAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api",
        },
        language: "en",
        previewLink:
          "http://books.google.co.in/books?id=rruOEAAAQBAJ&dq=atomic+habits&hl=&cd=1&source=gbs_api",
        infoLink:
          "http://books.google.co.in/books?id=rruOEAAAQBAJ&dq=atomic+habits&hl=&source=gbs_api",
        canonicalVolumeLink:
          "https://books.google.com/books/about/Atomic_Habits.html?hl=&id=rruOEAAAQBAJ",
      },
      saleInfo: {
        country: "IN",
        saleability: "NOT_FOR_SALE",
      ...
      accessInfo: {
        ...
        webReaderLink:
          "http://play.google.com/books/reader?id=rruOEAAAQBAJ&hl=&source=gbs_api",
        accessViewStatus: "NONE",
        quoteSharingAllowed: false,
      },
      searchInfo: {
    ...
    },
    {
      ...
      volumeInfo: {
        ...
        imageLinks: {
          smallThumbnail:
            "http://books.google.com/books/content?id=yzFYEAAAQBAJ&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api",
          thumbnail:
            "http://books.google.com/books/content?id=yzFYEAAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api",
        },
        language: "en",
        previewLink:
          "http://books.google.co.in/books?id=yzFYEAAAQBAJ&pg=PP1&dq=atomic+habits&hl=&cd=2&source=gbs_api",
        infoLink:
          "https://play.google.com/store/books/details?id=yzFYEAAAQBAJ&source=gbs_api",
        canonicalVolumeLink:
          "https://play.google.com/store/books/details?id=yzFYEAAAQBAJ",
      },
      saleInfo: {
        country: "IN",
        ...
        buyLink:
          "https://play.google.com/store/books/details?id=yzFYEAAAQBAJ&rdid=book-yzFYEAAAQBAJ&rdot=1&source=gbs_api",
        offers: [
          {
            finskyOfferType: 1,
            listPrice: {
      ...
      accessInfo: {
        ...
        epub: {
          isAvailable: true,
          acsTokenLink:
            "http://books.google.co.in/books/download/Atomic_Habits_Summary_by_James_Clear-sample-epub.acsm?id=yzFYEAAAQBAJ&format=epub&output=acs4_fulfillment_token&dl_type=sample&source=gbs_api",
        },
        pdf: {
          isAvailable: true,
          acsTokenLink:
            "http://books.google.co.in/books/download/Atomic_Habits_Summary_by_James_Clear-sample-pdf.acsm?id=yzFYEAAAQBAJ&format=pdf&output=acs4_fulfillment_token&dl_type=sample&source=gbs_api",
        },
        webReaderLink:
          "http://play.google.com/books/reader?id=yzFYEAAAQBAJ&hl=&source=gbs_api",
